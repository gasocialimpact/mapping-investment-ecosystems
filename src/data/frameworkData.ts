...
export const GLOSSARY: GlossaryGroup[] = [
  ...
  {
    group: 'Community Development Finance',
    items: [
      { term: 'NMTC — New Markets Tax Credit', def: 'A federal program administered by the CDFI Fund that incentivizes private investment in low-income communities by offering investors a 39% tax credit over 7 years. Investors make a Qualified Equity Investment (QEI) into a certified Community Development Entity (CDE), which deploys those funds as Qualified Low-Income Community Investments (QLICIs) to eligible businesses and projects in qualifying census tracts. Related: CDE, QEI, QLICI, QALICB, CDFI.' },
      { term: 'LIHTC — Low-Income Housing Tax Credit', def: 'A federal program that incentivizes private investment in affordable rental housing by providing tax credits to developers who reserve a share of units for households below specified income thresholds. Credits are allocated by state housing finance agencies and are commonly paired with CDBG or CDFI financing to close project funding gaps. Related: CHDO, CLT, CDC, CDBG.' },
      { term: 'CDBG — Community Development Block Grant', def: 'A federal formula grant program administered by HUD that provides flexible funding to communities for housing, infrastructure, and community development activities primarily benefiting low- and moderate-income residents. Unlike NMTC, CDBG is a direct grant and does not involve tax credits or private investment intermediaries. Related: CHDO, CDC, CLT, LIHTC.' },
      { term: 'ERP — CDFI Equitable Recovery Program', def: 'A CDFI Fund grant program established to support CDFIs serving communities that experienced disproportionate economic harm from the COVID-19 pandemic. ERP funding helps CDFIs build capital, lending capacity, and operational infrastructure to expand reach into underinvested communities. Related: CDFI.' },
      { term: 'QEI — Qualified Equity Investment', def: 'The investment made by a private investor (typically a large bank or corporation seeking tax credits) directly into a CDE under the NMTC program. The QEI must remain invested for 7 years to generate the full 39% credit. The CDE then uses these funds to make QLICIs into qualifying businesses and projects in low-income communities. Related: NMTC, CDE, QLICI.' },
      { term: 'QLICI — Qualified Low-Income Community Investment', def: 'The loan or equity investment made by a CDE to a Qualified Active Low-Income Community Business (QALICB) using funds raised through QEIs. QLICIs are the actual capital deployed into communities under the NMTC program — the point at which investor money reaches a specific business or development project on the ground. Related: NMTC, CDE, QEI, QALICB.' },
      { term: 'CDE — Community Development Entity', def: 'An organization certified by the CDFI Fund to receive NMTC allocations. CDEs raise Qualified Equity Investments from private investors and deploy those funds as QLICIs to eligible businesses and projects. Many CDFIs are also certified as CDEs, allowing them to access NMTC allocations alongside their other lending activity. Related: NMTC, QEI, QLICI, QALICB, CDFI.' },
      { term: 'CDFI — Community Development Financial Institution', def: "A financial institution certified by the U.S. Treasury's CDFI Fund whose primary mission is serving low-income and underserved communities. CDFIs include community development banks, credit unions, loan funds, and venture capital funds. Many CDFIs are also certified CDEs and can access ERP funding to expand lending capacity. Related: CDE, NMTC, ERP." },
      { term: 'CHDO — Community Housing Development Organization', def: "A nonprofit certified under HUD's HOME Investment Partnerships Program to develop affordable housing. Federal rules require at least 15% of HOME funds to be set aside for CHDOs. They often partner with CDCs and CLTs, and may stack LIHTC financing alongside HOME dollars to close project gaps. Related: LIHTC, CDBG, CDC, CLT." },
      { term: 'CLT — Community Land Trust', def: 'A nonprofit that acquires and permanently holds land in trust to preserve long-term affordability, most commonly for homeownership. Residents can purchase homes on CLT land at below-market prices while the CLT retains ownership of the underlying land. CLTs are a community wealth-building strategy and a mechanism for permanent affordability without ongoing subsidy. Related: CHDO, CDC, LIHTC, CDBG.' },
      { term: 'CDC — Community Development Corporation', def: 'A community-rooted nonprofit that develops and manages affordable housing, commercial real estate, and other community assets. CDCs often serve as QALICBs or partner with CDEs to access NMTC financing. They may also access CDBG and LIHTC, and frequently function as the on-the-ground development entity in larger community finance transactions. Related: NMTC, QALICB, CDE, CDBG, LIHTC, CHDO.' },
      { term: 'QALICB — Qualified Active Low-Income Community Business', def: 'A business or project located in a qualified low-income census tract that receives a QLICI from a CDE. To qualify, a business must meet specific requirements about where it operates and where it generates revenue. QALICBs are the end recipients of NMTC financing — the community-facing businesses and development projects the broader NMTC structure is designed to reach. Related: NMTC, CDE, QLICI, CDC.' },
    ],
  },
];
